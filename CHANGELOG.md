...
## [11.0.0](https://github.com/echasnovski/LazyVim/compare/v10.5.0...v11.0.0) (2023-10-22)
...
* **null-ls:** use none-ls instead of null-ls ([#1517](https://github.com/echasnovski/LazyVim/issues/1517))
* **options:** set default localleader to \
* **flash:** Make flash.nvim the default jump plugin for LazyVim

### Features

* add a keybind to search register ([#1170](https://github.com/echasnovski/LazyVim/issues/1170)) ([fc50c05](https://github.com/echasnovski/LazyVim/commit/fc50c055c3db561043e23b53afc270de2231fbb2))
* added `leader-L` to show the LazyVim changelog ([9387ab3](https://github.com/echasnovski/LazyVim/commit/9387ab388ec43cae0689405fcb21bb4ecf67322c))
* added aerial extra with integrations for edgy, telescope and lualine ([b43c57d](https://github.com/echasnovski/LazyVim/commit/b43c57d943b2a13460d45f01a288e98cb54f2c1f))
* added NEWS.md and option to automatically show when changed (enabled by default) ([73acab1](https://github.com/echasnovski/LazyVim/commit/73acab16758d37982bd6b2d9b2be37c4ee83cde3))
* **autocmds:** close InspectTree window with q ([e54d0dd](https://github.com/echasnovski/LazyVim/commit/e54d0dde623c206c4f7ed9a512785c9fc0de3a22))
* **black:** added an extra for black with none-ls & conform.nvim ([#1245](https://github.com/echasnovski/LazyVim/issues/1245)) ([5219cad](https://github.com/echasnovski/LazyVim/commit/5219cad564152337d5d48572466ac976f300a557))
* **bufremove:** ask to save changes before trying to remove a buffer ([54df3e2](https://github.com/echasnovski/LazyVim/commit/54df3e26aca5c5c4da746f210e6f7e7de30673bb))
* **catppuccin:** enable mason integration ([#1048](https://github.com/echasnovski/LazyVim/issues/1048)) ([27eb461](https://github.com/echasnovski/LazyVim/commit/27eb4610bd0ffd48243f793054c7c9ab5ba08cb1))
* **catppuccin:** match navic bg with lualine ([#1085](https://github.com/echasnovski/LazyVim/issues/1085)) ([67d1cbf](https://github.com/echasnovski/LazyVim/commit/67d1cbfb01e84083649027a4b6356401f74d2d60))
* **clangd:** better clangd root detection ([#1165](https://github.com/echasnovski/LazyVim/issues/1165)) ([d71ebea](https://github.com/echasnovski/LazyVim/commit/d71ebeab24565bb109adc68253c2da6614eb5dda))
* **clangd:** remove CMakelists root_dir search ([#1230](https://github.com/echasnovski/LazyVim/issues/1230)) ([9264c54](https://github.com/echasnovski/LazyVim/commit/9264c54ae96d1d56f029ad9b561326c7b991c53b))
* **cmp:** added custom comparator to prioritize AI sources like copilot and codeium ([eddd3af](https://github.com/echasnovski/LazyVim/commit/eddd3af3512133f22eb26dda81c3c6f871453276))
* **cmp:** ctrl+CR will abort cmp and enter a new line ([d894556](https://github.com/echasnovski/LazyVim/commit/d894556c375c1c2398f170c21f9323c9c1eba9d4))
* **cmp:** removed priority comparator in favor of source priorities for copilot/codeium ([bff3a99](https://github.com/echasnovski/LazyVim/commit/bff3a996971c1f526eb893d8e778daa19a4245b5))
* **codeium:** add codeium extra ([#1619](https://github.com/echasnovski/LazyVim/issues/1619)) ([af9e452](https://github.com/echasnovski/LazyVim/commit/af9e4528543d98bccce333d39eccc34e433ef6dc))
* **codeium:** added lualine component with codeium status similar to copilot ([b05783d](https://github.com/echasnovski/LazyVim/commit/b05783de8c518c8a6e5c3f648448c3a6f00d0050))
* **codeium:** use actual codeium icon ([302c1ff](https://github.com/echasnovski/LazyVim/commit/302c1ff66e5b1d7bbe95f29e81c2d642e2cd4468))
* **config:** `lazyvim.json` is now versioned and migrates to a newer version when needed ([c989265](https://github.com/echasnovski/LazyVim/commit/c9892652d271663f52edd7b0d88d2565d8f65a52))
* **config:** better kind filter default for lua to deal with luals weirdness ([f64039f](https://github.com/echasnovski/LazyVim/commit/f64039f54620fe3fc9e8f464e35b184c6834ed6e))
* **config:** load/save some data in lazyvim.json ([11d66e7](https://github.com/echasnovski/LazyVim/commit/11d66e713467410add9ad5a7a68a3bca0aa24082))
* **config:** make kind filter configurable for telescope/aerial/... ([eb7a7d7](https://github.com/echasnovski/LazyVim/commit/eb7a7d7a8e586d30ed6839f4a621e0f019d32410))
* **config:** use lazy's new custom events (`Event.mappings`) for a better `LazyFile` ([4ea1c68](https://github.com/echasnovski/LazyVim/commit/4ea1c6865e6d877207de8626e11a5a863950ae55))
* **conform:** added new keymap (leader-cF) to format injected languages ([86d3694](https://github.com/echasnovski/LazyVim/commit/86d36946727bade57918c6a358c6b6bae52d441b))
* **conform:** ignore formatting errors for injected languages and fix condition example ([a1c5886](https://github.com/echasnovski/LazyVim/commit/a1c5886947e20059ad7802e71e0a82b413af6657))
* **conform:** make it easier to add `extra_args` ([3eb91c6](https://github.com/echasnovski/LazyVim/commit/3eb91c64b5960ccd84bd8e6a3318a1ee79cb85c5))
* **conform:** set vim.opt.formatexpr ([766d5e5](https://github.com/echasnovski/LazyVim/commit/766d5e5bf7a8e40910a00aef4dc30f36376e5652))
* **conform:** show error when user overwrites conform config function ([b6e68fa](https://github.com/echasnovski/LazyVim/commit/b6e68fa2bf829753be86ba8cc56baafd47b7da67))
* **conform:** use conform.nvim `opts.format` options for formatting with conform ([6fd66f4](https://github.com/echasnovski/LazyVim/commit/6fd66f486e210e35b4c375691fbfd61a611b6027))
* **dap:** added run with args `leader-ca`. Fixes [#1629](https://github.com/echasnovski/LazyVim/issues/1629) ([b1c9fd1](https://github.com/echasnovski/LazyVim/commit/b1c9fd15bdbc0bae5bf1ba1efd88ce7355e7f2c1))
* **dashboard:** `c` on dahboard now opens telescope for config dir instead of useless `init.lua` ([53e1637](https://github.com/echasnovski/LazyVim/commit/53e1637a864cb7e8f21af107b8073bc8b24acd11))
* **dashboard:** add projects if enabled ([#1595](https://github.com/echasnovski/LazyVim/issues/1595)) ([6f1cdfe](https://github.com/echasnovski/LazyVim/commit/6f1cdfe4bd2ec9a85c92a312fa52ba86e02d1a9f))
* **dashboard:** added LazyExtras shortcut to dashboard/alpha ([5bb7420](https://github.com/echasnovski/LazyVim/commit/5bb74205a06a89f048902ba142473dd679b228b8))
* **dashboard:** remove unnecessary brackets from keys ([#1791](https://github.com/echasnovski/LazyVim/issues/1791)) ([d73aee4](https://github.com/echasnovski/LazyVim/commit/d73aee4a934b0aa12e07039da9e2df0215ba2cba))
* **dashboard:** show loaded/count plugins on dashboard instead of just count ([9670c8a](https://github.com/echasnovski/LazyVim/commit/9670c8a400100d38e15c9662f488232508bfb1bb))
* disable kind_filter for markdown and help ([782fe0b](https://github.com/echasnovski/LazyVim/commit/782fe0bef0789c8f090284df80c00799471bc16f))
* **edgy:** when edgy is enabled, use edgy's main window for Telescope to open results in ([fb70170](https://github.com/echasnovski/LazyVim/commit/fb7017005809d6be06a1ece748ef2406c37a34d9))
* **elixir:** Add credo if none-ls is used ([#1546](https://github.com/echasnovski/LazyVim/issues/1546)) ([2ffd629](https://github.com/echasnovski/LazyVim/commit/2ffd629cc7a68e6e4a721ac8babe6b7cf612868e))
* Enable flash.nvim highlight on catppuccin integration ([#1206](https://github.com/echasnovski/LazyVim/issues/1206)) ([76d33bb](https://github.com/echasnovski/LazyVim/commit/76d33bba2cc8bd691979ee8bc66f8ac36236c3ba))
* **extra:** Add Elixir support and config ([#993](https://github.com/echasnovski/LazyVim/issues/993)) ([3d0de23](https://github.com/echasnovski/LazyVim/commit/3d0de235eca0ea6987947e4a7c47f1393e42dfb2))
* **extra:** add extra `util.dot` that configures multiple ft and treesitter langs when needed ([639a6e7](https://github.com/echasnovski/LazyVim/commit/639a6e7545830602c09711b3757a28537baf8e75))
* **extra:** add yaml language extension ([#1198](https://github.com/echasnovski/LazyVim/issues/1198)) ([6dc6685](https://github.com/echasnovski/LazyVim/commit/6dc66852b8851f02b372e8a2882fddf04b3b6966))
* **extras:** add terraform extra ([#1030](https://github.com/echasnovski/LazyVim/issues/1030)) ([0db31c2](https://github.com/echasnovski/LazyVim/commit/0db31c2840af662c856d5b9a09d87bc266e7fa40))
* **extras:** added `conform.nvim` extra you can use instead of null-ls/none-ls ([f61a243](https://github.com/echasnovski/LazyVim/commit/f61a243d1aca582963aca3f2c2c7c2ae0be16b06))
* **extras:** added extra for `symbols-outline.nvim` ([b4ba5d8](https://github.com/echasnovski/LazyVim/commit/b4ba5d881dcb801d3c502665f9767d2f75ca1110))
* **extras:** added extra for dashboard.nvim ([417de01](https://github.com/echasnovski/LazyVim/commit/417de0193dd0663100a8b1eaedc2bc4976712c61))
* **extras:** added extra for mini.files ([e624511](https://github.com/echasnovski/LazyVim/commit/e624511fa249bc3af58e61b0ee5fdd4426bc2977))
* **extras:** added extra for nvim-lint ([05f45bb](https://github.com/echasnovski/LazyVim/commit/05f45bb7200a6fd33ab7366553b957fa222e2cdf))
* **extras:** added simple csharp extra ([afdcec5](https://github.com/echasnovski/LazyVim/commit/afdcec5b4adccd94ff64774340a3ffd33a9d4ecf))
* **extras:** added TabNine ([#1651](https://github.com/echasnovski/LazyVim/issues/1651)) ([95ff5aa](https://github.com/echasnovski/LazyVim/commit/95ff5aaa6245244d45609916b0a623c5e8c79d16))
* **extras:** added yanky extra (yank-ring) ([a1820c1](https://github.com/echasnovski/LazyVim/commit/a1820c1b428fc7f72fc31ea8465260b1816349ab))
* **extras:** LazyExtras can now manage user extras `lua/plugins/extras`. Fixes [#1681](https://github.com/echasnovski/LazyVim/issues/1681) ([1bcf6b9](https://github.com/echasnovski/LazyVim/commit/1bcf6b9a282bc839d4fde92a94b800185ad58118))
* **flash:** add treesitter to normal mode as well ([aa28119](https://github.com/echasnovski/LazyVim/commit/aa28119aa6526d26920da25c35e83d856a8584fb))
* **flash:** added remote flash ([c3477ed](https://github.com/echasnovski/LazyVim/commit/c3477ed81e8e26bce1eb53f9c04a8aa7adc1807a))
* **flash:** added treesiter search to show ts node labels around search matches ([5e6a072](https://github.com/echasnovski/LazyVim/commit/5e6a07200c0cc0a21167a341c1f29bf27dc35f02))
* **flash:** enable flash in vscode ([f6f8436](https://github.com/echasnovski/LazyVim/commit/f6f8436fe8696a8934a28a1fd21bf28409fee7ab))
* **flash:** Make flash.nvim the default jump plugin for LazyVim ([ae759b9](https://github.com/echasnovski/LazyVim/commit/ae759b947b1ef16d9814fcddfcafe2cdd767bc6a))
* **flash:** telescope integration. Use `s` in normal and `&lt;c-s&gt;` in insert mode ([12b5723](https://github.com/echasnovski/LazyVim/commit/12b57235a9f8dd15914d0b2133817259e80d63a1))
* **flash:** use c-s in the cmdline to toggle flash ([22c9477](https://github.com/echasnovski/LazyVim/commit/22c9477b9642b1a8abc303ffcb44c6989c7a5ca2))
* **format:** new LazyVim formatter with integrations for lsp/none-ls/conform/eslint/... ([f1a8f24](https://github.com/echasnovski/LazyVim/commit/f1a8f24a361d0de198f6b1458168652a6835c932))
* **format:** show warning when no formatter ran when using the format keymap ([e36f7d8](https://github.com/echasnovski/LazyVim/commit/e36f7d811c396b60bcbf65f962b3f52d2f75b0b3))
* **format:** use conform as lsp formatter since it has better format diffs ([4584410](https://github.com/echasnovski/LazyVim/commit/4584410e76bf8a6ba426270bef8eca5a100d4cce))
* **go:** add fine-tuned LSP options, add some null-ls sources ([#1024](https://github.com/echasnovski/LazyVim/issues/1024)) ([4ba5086](https://github.com/echasnovski/LazyVim/commit/4ba5086b3d9f9690e8fd7d93102db66173b02638))
* **go:** add gofumpt formatter with conform/none-ls ([#1683](https://github.com/echasnovski/LazyVim/issues/1683)) ([385c99d](https://github.com/echasnovski/LazyVim/commit/385c99dbb7ccdcf53276086892cceee65b85fa21))
* **go:** add goimports ([#1549](https://github.com/echasnovski/LazyVim/issues/1549)) ([e8ab2ff](https://github.com/echasnovski/LazyVim/commit/e8ab2ff5b6a75952943d3ba44586c7de5588be33))
* **inject:** util method to get upvalue ([14f3f03](https://github.com/echasnovski/LazyVim/commit/14f3f036e9223315f310ba9d35182690638e7bd7))
* **java:** add test and debug support for Java extension ([#1192](https://github.com/echasnovski/LazyVim/issues/1192)) ([f6d646a](https://github.com/echasnovski/LazyVim/commit/f6d646a3251efb39f7cb5de38b529c5dd1324f28))
* **java:** support vscode launch json in Java ([#1422](https://github.com/echasnovski/LazyVim/issues/1422)) ([5dc4ce3](https://github.com/echasnovski/LazyVim/commit/5dc4ce3e4a452438838c271330df156fd3640c60))
* **keymaps:** added leader-K to run keywordprg ([a28acf0](https://github.com/echasnovski/LazyVim/commit/a28acf0ce7d00af11e7268c9edff579bd06abf56))
* **keymaps:** added support for lazy's per-mode keymap disabling ([1bc7827](https://github.com/echasnovski/LazyVim/commit/1bc78272da28821479e98df528d399214a8cdbee))
* **keymaps:** added toggle for relative line numbers ([3f868aa](https://github.com/echasnovski/LazyVim/commit/3f868aa8254efbd494f6bf100c86a59c5a002c1c))
* **keymaps:** added toggle for treesitter highlights ([be5eea4](https://github.com/echasnovski/LazyVim/commit/be5eea476c98d46aefbbaee04b7f2bc82bb51c27))
* **lang:** add C/C++ support ([#1025](https://github.com/echasnovski/LazyVim/issues/1025)) ([e5200e6](https://github.com/echasnovski/LazyVim/commit/e5200e6358766f2ba71eb229cb335c4c811902bb))
* **lang:** add cmake support ([#1032](https://github.com/echasnovski/LazyVim/issues/1032)) ([fa898b7](https://github.com/echasnovski/LazyVim/commit/fa898b7293c6c67b0ae2bae1d3be70413bcadd8d))
* **lang:** add debug adapter plugin for go ([#1115](https://github.com/echasnovski/LazyVim/issues/1115)) ([02d673d](https://github.com/echasnovski/LazyVim/commit/02d673d37c6a097a43db877644e20db84f0880b1))
* **lang:** add docker support ([#1078](https://github.com/echasnovski/LazyVim/issues/1078)) ([a0c2014](https://github.com/echasnovski/LazyVim/commit/a0c2014b1045243d216b244235c6a545e92471a9))
* **lang:** add java ([#1132](https://github.com/echasnovski/LazyVim/issues/1132)) ([0411baa](https://github.com/echasnovski/LazyVim/commit/0411baab8985450a15a54a46c48197b704bc24cc))
* **lang:** add markdown support ([#1718](https://github.com/echasnovski/LazyVim/issues/1718)) ([b3d46bc](https://github.com/echasnovski/LazyVim/commit/b3d46bc0141c23bfd4302718ff42dfa172c6952b))
* **lang:** add null-ls tools to mason's ensure_installed ([#1133](https://github.com/echasnovski/LazyVim/issues/1133)) ([63e8985](https://github.com/echasnovski/LazyVim/commit/63e898599a00d8b1832de650ed67f63a44bf22e0))
* **lang:** add python support ([#1031](https://github.com/echasnovski/LazyVim/issues/1031)) ([44cdb5e](https://github.com/echasnovski/LazyVim/commit/44cdb5eac556733db53afeebcdc6ef91408de0c3))
* **lang:** Add Rust config ([#1012](https://github.com/echasnovski/LazyVim/issues/1012)) ([5a441f8](https://github.com/echasnovski/LazyVim/commit/5a441f897247b130c1ffb78bb37fd3a16d2250de))
* **lang:** add tex support ([#1156](https://github.com/echasnovski/LazyVim/issues/1156)) ([abaa6d9](https://github.com/echasnovski/LazyVim/commit/abaa6d90e4fe2c658b869e81a140a74f624d9299))
* **linting:** ability to configure global and fallback linters ([#1727](https://github.com/echasnovski/LazyVim/issues/1727)) ([6e0e352](https://github.com/echasnovski/LazyVim/commit/6e0e352fea4cd930ea7fc42a0252c2c70b279bee))
* **lsp:** add 'reuse_win' for reuse window in lsp definition keymap ([#1131](https://github.com/echasnovski/LazyVim/issues/1131)) ([1b0b6eb](https://github.com/echasnovski/LazyVim/commit/1b0b6eb0e13018196f0110b06149f00f2df5162f))
* **lsp:** added support to lsp keymaps for dynamic capabilities ([d0bc8b7](https://github.com/echasnovski/LazyVim/commit/d0bc8b7dcea44b7bc46580ce21001c4509d046c3))
* **lsp:** custom lsp keymaps ([61e3ce8](https://github.com/echasnovski/LazyVim/commit/61e3ce8cdc1159d59e11d92478ca76ea19e44c2a))
* **lualine:** new root dir component that only shows when cwd != root_dir ([dfdfcad](https://github.com/echasnovski/LazyVim/commit/dfdfcad1aab0ee39ac3876e47cbeb727eb4f1e95))
* **lualine:** pretty_path now highlights file basename when modified ([8af7309](https://github.com/echasnovski/LazyVim/commit/8af7309c7e31f55125eaade5fe86d04d63133999))
* **lualine:** use gitsigns for diff source ([#1744](https://github.com/echasnovski/LazyVim/issues/1744)) ([8c726cd](https://github.com/echasnovski/LazyVim/commit/8c726cd16638f51308f479f26143d94a6c3013ea))
* make `conform.nvim` and `nvim-lint` the default formatters/linters ([14c091b](https://github.com/echasnovski/LazyVim/commit/14c091b1fc6b0dc0b22ac49ccac69f8a02e3844c))
* **markdown:** added headlines.nvim to markdown extra ([152e1c6](https://github.com/echasnovski/LazyVim/commit/152e1c6692566a2e2a3968fbfc6eca69d33ba02c))
* **mini-pairs:** add toggle mini pairs keymap and function ([#1456](https://github.com/echasnovski/LazyVim/issues/1456)) ([a7f971f](https://github.com/echasnovski/LazyVim/commit/a7f971f30ec89473482db4ab820d2afb25fa6abf))
* **mini.ai:** decouple mini.ai from which-key. Closes [#1076](https://github.com/echasnovski/LazyVim/issues/1076) ([e212c16](https://github.com/echasnovski/LazyVim/commit/e212c166b4ce91bbd65a9f7fda17403ee91ed19c))
* **mini.files:** "g." to toggle hidden files ([#964](https://github.com/echasnovski/LazyVim/issues/964)) ([a080bc7](https://github.com/echasnovski/LazyVim/commit/a080bc7667b6fadc175d782469b063fcf09b00ae))
* **mini.files:** added extra keymap to open mini.files in the cwd ([5299522](https://github.com/echasnovski/LazyVim/commit/52995227808371a537f6d42ad2f0656571b92299))
* **mini.files:** added lsp rename support to mini.files ([4ff51cd](https://github.com/echasnovski/LazyVim/commit/4ff51cd678343ea32668eaf0c1103caacb4334a2))
* **mini.starter:** adding mini.starter to lualine disabled files ([#1667](https://github.com/echasnovski/LazyVim/issues/1667)) ([1c34af7](https://github.com/echasnovski/LazyVim/commit/1c34af7f0138323d9f465437d0bcef621a8dbe94))
* **mini.surround:** default surround mappings are now gs instead of gz (unless you enabled the leap extra) ([d28c69e](https://github.com/echasnovski/LazyVim/commit/d28c69e49eab62b45f7d1562b3bc00afee5fbb65))
* **navic:** moved navic to extras ([305e82f](https://github.com/echasnovski/LazyVim/commit/305e82f2cacd5d0074027ea545a87a41379afc88))
* **neo-tree:** added support for LSP renaming to NeoTree ([9762e7e](https://github.com/echasnovski/LazyVim/commit/9762e7e43110013a0931b8470be2929b54b4b641))
* **neo-tree:** update to v3.x and change `follow_current_file` to a … ([#1143](https://github.com/echasnovski/LazyVim/issues/1143)) ([69bb891](https://github.com/echasnovski/LazyVim/commit/69bb89184f9297f1377f77a8b6bee2487df6ac00))
* **neot-ree:** add keymaps to toggle git & buffer ([#1339](https://github.com/echasnovski/LazyVim/issues/1339)) ([b31d71d](https://github.com/echasnovski/LazyVim/commit/b31d71da9d6ca6c290a8ee7e7cc7ad5ccb3cc0bd))
* **nlua:** make lua dap keybindings buffer-local ([9372d78](https://github.com/echasnovski/LazyVim/commit/9372d78e7e4ed46612de9818868373da81b6f4f1))
* **null-ls:** use none-ls instead of null-ls ([#1517](https://github.com/echasnovski/LazyVim/issues/1517)) ([7cac6f0](https://github.com/echasnovski/LazyVim/commit/7cac6f064c5b30f6b0ae4dffab62100aa6fe2568))
* **options:** enable smoothscroll on nightly ([450e0c6](https://github.com/echasnovski/LazyVim/commit/450e0c6bebc5bb9a0c513cdffaf9c46d5f62d5fa))
* **options:** enabled treesitter folding and foldtext when available ([19926d2](https://github.com/echasnovski/LazyVim/commit/19926d284862b5e58f29e73b71ec532ac29c54ba))
* **options:** set `virtualedit=block` by default ([6b857f1](https://github.com/echasnovski/LazyVim/commit/6b857f1de648292f2410f9beaa95318bd30454d5))
* **options:** set default localleader to \ ([258f339](https://github.com/echasnovski/LazyVim/commit/258f339bcf8197ece54d66bf6ed6f351cb6e98cb))
* **python:** add key binding for organize imports ([#1670](https://github.com/echasnovski/LazyVim/issues/1670)) ([8f42733](https://github.com/echasnovski/LazyVim/commit/8f42733ce526b6c866b26824d78a1822730c2852))
* **python:** add more venv names ([#1381](https://github.com/echasnovski/LazyVim/issues/1381)) ([377c0e3](https://github.com/echasnovski/LazyVim/commit/377c0e397c3585cf7bae6afb8bd279a47954be0a))
* **python:** add semantic highlighting ([#1149](https://github.com/echasnovski/LazyVim/issues/1149)) ([012ca50](https://github.com/echasnovski/LazyVim/commit/012ca50b2801cc1c4e5b886cc26ebe0da532e31d))
* replace Copilot icon with logo ([#1539](https://github.com/echasnovski/LazyVim/issues/1539)) ([9bb4e87](https://github.com/echasnovski/LazyVim/commit/9bb4e8755f5a822659ca1d8cb3689732435d90d0))
* **root:** allow custom functions as part of `vim.g.root_spec` ([c33e748](https://github.com/echasnovski/LazyVim/commit/c33e7489ecdaef7295a63079410f2f24a1cbc9b6))
* **root:** cached pretty path function for statuslines ([8d7361c](https://github.com/echasnovski/LazyVim/commit/8d7361c4602993a7ea119cb7ce78d421b6787dfb))
* **root:** customizable root detection and `:LazyRoot` command ([a2d6049](https://github.com/echasnovski/LazyVim/commit/a2d604928b5629d14797437a26022065f7385216))
* **rust:** make mason optional ([272f6af](https://github.com/echasnovski/LazyVim/commit/272f6af842eb66b6e6cbdea211b17a1196acdff5))
* **rust:** make taplo configurable ([eaa0118](https://github.com/echasnovski/LazyVim/commit/eaa0118dd2c91911f1457ea31b976a7c8f93164a))
* **rust:** refactor to allow easy user customization and keymaps ([a46d476](https://github.com/echasnovski/LazyVim/commit/a46d47653e092f7689203ee39c9f964b1bd2d5f4))
* **rust:** rust improvements ([#1015](https://github.com/echasnovski/LazyVim/issues/1015)) ([79b1c92](https://github.com/echasnovski/LazyVim/commit/79b1c92dd22020b2a5ed1dbd6e6bb86242207785))
* show error and exit Neovim when version is too old ([2aea5c7](https://github.com/echasnovski/LazyVim/commit/2aea5c7210882a2f98526ee29115fe2e1a41d7b4))
* **starter:** `dashboard.nvim` is now the default starter. To keep using `alpha.nvim`, enable the extra. ([4cbe42c](https://github.com/echasnovski/LazyVim/commit/4cbe42cd247c72dfc70c3fcddfa3fb6b5e6485e0))
* **starter:** added Lazy Extras to `mini.starter` ([ce74e28](https://github.com/echasnovski/LazyVim/commit/ce74e28464daa7d694f9ab4e41fae3174e30c8b3))
* **tabnine:** add build cmd for Windows ([#1737](https://github.com/echasnovski/LazyVim/issues/1737)) ([c8e5501](https://github.com/echasnovski/LazyVim/commit/c8e5501ee5ecd1a7b27ff3aa5f41e54c2e98ff0b))
* **telescope:** add telescope-fzf-native by default. Will only be enabled if `make` is on your system. ([44984dc](https://github.com/echasnovski/LazyVim/commit/44984dcbe25c13e0e1bc582d5a51ccc2a4be8f70))
* **telescope:** allow word and selection searches ([#1096](https://github.com/echasnovski/LazyVim/issues/1096)) ([6b2c648](https://github.com/echasnovski/LazyVim/commit/6b2c648878b8df538d719c06394bc430cc3ed48c))
* **telescope:** smarter way to determine the window to open a file in ([c0ce89f](https://github.com/echasnovski/LazyVim/commit/c0ce89fe62bffc0fe35bf76d3e5f501c8b5276c2))
* **toggle:** add keymap to toggle treesitter context ([#1711](https://github.com/echasnovski/LazyVim/issues/1711)) ([5e1a86d](https://github.com/echasnovski/LazyVim/commit/5e1a86d3b257db37c8b443deea6ca1fefcb0b1aa))
* **treesitter:** add diff, jsonc and yaml by default ([c9bbb92](https://github.com/echasnovski/LazyVim/commit/c9bbb922e58b223d49785cddbed2feeea536237e))
* **treesitter:** add jsdoc to ensure_installed ([#1252](https://github.com/echasnovski/LazyVim/issues/1252)) ([566049a](https://github.com/echasnovski/LazyVim/commit/566049aa4a26a86219dd1ad1624f9a1bf18831b6))
* **treesitter:** add nvim-treesitter-context by default ([7b2c317](https://github.com/echasnovski/LazyVim/commit/7b2c31740782fb0754ce715be6ea128083e48c4f))
* **treesitter:** added ]f, [f, ]F, [F, ]c, ]C, [c, [C for treesitter-textobjects ([0e66ef8](https://github.com/echasnovski/LazyVim/commit/0e66ef83934eb62ee2237e331dcbc0a22b809aae))
* **treesitter:** install nvim-ts-autotag by default ([cb7f5ac](https://github.com/echasnovski/LazyVim/commit/cb7f5aca7a04cf2d1d06397e9a80fe078d17976b))
* **treesitter:** map `vim` to `[@namespace](https://github.com/namespace).builtin` ([5f0713d](https://github.com/echasnovski/LazyVim/commit/5f0713d2b612a814586bffec39700ab6a30dc0ea))
* **typescript:** add typescriptreact/javascriptreact to types ([#1574](https://github.com/echasnovski/LazyVim/issues/1574)) ([626ae13](https://github.com/echasnovski/LazyVim/commit/626ae1338a88f6cd8962d6c20bd79953a67f0b72))
* **typescript:** added remove unused imports ([#1794](https://github.com/echasnovski/LazyVim/issues/1794)) ([8df44b3](https://github.com/echasnovski/LazyVim/commit/8df44b3bb54483e42a27dc30a8b343acc5d5d242))
* **ui:** add keymap to close other buffers ([#1743](https://github.com/echasnovski/LazyVim/issues/1743)) ([c3daced](https://github.com/echasnovski/LazyVim/commit/c3daced11ce33875059ad5dd74832bf4a232f195))
* **ui:** added `:LazyExtras` to manage enabled extras in LazyVim ([c4e55e4](https://github.com/echasnovski/LazyVim/commit/c4e55e4d67a7195b7aa9160cd8ece3ddc2f6cb51))
* **ui:** fancy fold text ([f1ce075](https://github.com/echasnovski/LazyVim/commit/f1ce07510d2048e33fec2b609814d68a7175d591))
* **ui:** fancy status column ([364bcf3](https://github.com/echasnovski/LazyVim/commit/364bcf325d91a06e6bd6516bdfed84399566cdb6))
* **ui:** show alpha marks in statuscolumn ([bd2ac54](https://github.com/echasnovski/LazyVim/commit/bd2ac542a0bb4c58237cd6ca8848063bd20a5282))
* **ui:** show optional plugins in a different color ([eedb4a3](https://github.com/echasnovski/LazyVim/commit/eedb4a34050443448d0b752e22803d5b1278b419))
* **util:** added util.on_load to execute code when a plugin loads ([9fd8970](https://github.com/echasnovski/LazyVim/commit/9fd89701da8bd3a5d9ffeae84fb2174a3f650797))
* **util:** inject module ([e239235](https://github.com/echasnovski/LazyVim/commit/e239235cd34ac9c286eac1e620670784566ef673))
* **vscode:** easier way to enable/disable plugins ([ae054ec](https://github.com/echasnovski/LazyVim/commit/ae054ec13c987ff5ce39cfc88917f8243abae72e))


### Bug Fixes

* [#1194](https://github.com/echasnovski/LazyVim/issues/1194) use cmakelang instead of cmakelint ([#1197](https://github.com/echasnovski/LazyVim/issues/1197)) ([b97ccb9](https://github.com/echasnovski/LazyVim/commit/b97ccb9e7390b6e73e3f1a4d63a443f6cec67f07))
* [#1305](https://github.com/echasnovski/LazyVim/issues/1305) rust debugging not working on windows due to missing liblldb path ([#1390](https://github.com/echasnovski/LazyVim/issues/1390)) ([6045a52](https://github.com/echasnovski/LazyVim/commit/6045a52d82ba4b0dcd0b050688302a22c2fc3991))
* **aerial:** keymap ([c772027](https://github.com/echasnovski/LazyVim/commit/c7720275c3fa8b19c9ad7e05bfb6ed5c510bf2bb))
* **aerial:** use new sep_icon option for aerial lualine component ([bd1928b](https://github.com/echasnovski/LazyVim/commit/bd1928ba597d777ca79f9f2f4b14217de4c291bc))
* **alpha:** reset laststatus when alpha unloads. Fixes [#1623](https://github.com/echasnovski/LazyVim/issues/1623) ([30d5735](https://github.com/echasnovski/LazyVim/commit/30d573502a2f9264273a14143e6bddb0b876a391))
* **alpha:** use `&lt;cmd&gt;` instead of `:` for shortcuts ([1abcffb](https://github.com/echasnovski/LazyVim/commit/1abcffbfd940588fa67cc7438ce2115df1c58e92))
* always lazy load keymaps. fixes [#1485](https://github.com/echasnovski/LazyVim/issues/1485) ([f892ba5](https://github.com/echasnovski/LazyVim/commit/f892ba5cffe8fcac724ad6b801e0824b391fa037))
* **autocmds:** dont jump to last loc in gitcommit buffers ([65c70f6](https://github.com/echasnovski/LazyVim/commit/65c70f6ad7e386b54d2aa6dbe137c37ee1d3cb88))
* **autocmds:** extra check that we didn't do last_loc more than once for the buffer ([5d44c97](https://github.com/echasnovski/LazyVim/commit/5d44c976a746e29cfe52ceab93dd3de5db2eafa8))
* **autocmds:** jump to last loc in buffer ([#1061](https://github.com/echasnovski/LazyVim/issues/1061)) ([baa9614](https://github.com/echasnovski/LazyVim/commit/baa96140227a3727b2ea2053f37aa2b7253bb45a))
* **autocmds:** last_loc autocmd didn't work correctly for first opened file ([0cc80b1](https://github.com/echasnovski/LazyVim/commit/0cc80b1b0594516ccc2c1e6c9a60c84012a29abb))
* **autocmds:** restore tabpage on resize ([#1260](https://github.com/echasnovski/LazyVim/issues/1260)) ([f9dadc1](https://github.com/echasnovski/LazyVim/commit/f9dadc11b39fb0b027473caaab2200b35c9f0c8b))
* **autocmds:** retore last location for correct buffer ([afc8e7f](https://github.com/echasnovski/LazyVim/commit/afc8e7f8cac06335efd12ec5f71cabb1f38a09b0))
* **black:** remove unknown blackd from conform ([#1640](https://github.com/echasnovski/LazyVim/issues/1640)) ([1779858](https://github.com/echasnovski/LazyVim/commit/177985842665921e11f9e9813348fd6bef852e27))
* **bufferline:** fix bufferline when restoring a session ([838ce85](https://github.com/echasnovski/LazyVim/commit/838ce85ad6ae2dc2fa1d7518b0c5eb1eb8fe29b2))
* **bufferline:** load bufferline on VeryLazy. Fixes [#1587](https://github.com/echasnovski/LazyVim/issues/1587) ([7272b3e](https://github.com/echasnovski/LazyVim/commit/7272b3e4b5b626597658dabf774998057892d066))
* **catppuccin:** change nvim-tree integration to neo-tree for catppuccin/nvim plugin ([#1003](https://github.com/echasnovski/LazyVim/issues/1003)) ([2f2c7a3](https://github.com/echasnovski/LazyVim/commit/2f2c7a32a4115d06c3bb2b12e6d55f163d701bb3))
* **clangd:** update setup from upstream changes ([#1308](https://github.com/echasnovski/LazyVim/issues/1308)) ([73dc5a5](https://github.com/echasnovski/LazyVim/commit/73dc5a503f1f42fc12869688df1359ffd80da5d1))
* cleanup all Neovim &lt; 0.9.0 code ([9935dc3](https://github.com/echasnovski/LazyVim/commit/9935dc3944c4724d7ee7f70b6bc450f8c3b34a08))
* **cmp:** properly set cmp `group_index` to fix issues with copilot and other sources ([#1639](https://github.com/echasnovski/LazyVim/issues/1639)) ([de93848](https://github.com/echasnovski/LazyVim/commit/de93848f584b3443204247f49b405b81b0a3d4c1))
* **cmp:** set default group_index to 1 to prevent issues with custom sources ([0a05888](https://github.com/echasnovski/LazyVim/commit/0a05888d992b37749f9aae25c7f63f2534ec1024))
* **config:** disable LazyFile till v10.0 ([ee7a401](https://github.com/echasnovski/LazyVim/commit/ee7a401388f2933729afcd7090fb8e69631b912f))
* **config:** dont append LazyVim early to the rtp when bootstrapping ([4e0a058](https://github.com/echasnovski/LazyVim/commit/4e0a05808cb0997e0ac7d939421f68e9dfa5d74d))
* **config:** fixed issues related to LazyFile. Fixes [#1601](https://github.com/echasnovski/LazyVim/issues/1601) ([6e0e01f](https://github.com/echasnovski/LazyVim/commit/6e0e01f5b4dd7e97abbb50241a207d36d0ce9cd5))
* **config:** make lazyvim.json idempotent, pretty-printed and remove full paths ([2a0b7a8](https://github.com/echasnovski/LazyVim/commit/2a0b7a88ba4b4562361dd5abb4a071547d004e59))
* **config:** trigger all buf filetype events on LazyFile ([862e140](https://github.com/echasnovski/LazyVim/commit/862e140a7ad8452cd5a103982687fca63a2f44da))
* **config:** trigger LazyFile additionally on BufWritePre for saving unnamed files ([e11a3cb](https://github.com/echasnovski/LazyVim/commit/e11a3cbe800a1216062f7cefd25827f6fdad9daa))
* **conform:** allow overriding all conform format options. Fixes [#1790](https://github.com/echasnovski/LazyVim/issues/1790) ([ea3155a](https://github.com/echasnovski/LazyVim/commit/ea3155aef6d47e744cb2b4a7a3b567288d780f8d))
* **conform:** dont try merging function formatters. Fixes [#1582](https://github.com/echasnovski/LazyVim/issues/1582) ([f475085](https://github.com/echasnovski/LazyVim/commit/f4750859f2c2c9a41b3974ac05962ce9648d6c16))
* **conform:** dont try to merge formatter functions ([9f034ab](https://github.com/echasnovski/LazyVim/commit/9f034ab10650e306e178d5189ee9214a52f2e8e5))
* **conform:** remove LazyVim's conform config changes since that's now merged in conform ([982c8e3](https://github.com/echasnovski/LazyVim/commit/982c8e301bb432f44a85d915a8268442c7db05fa))
* **conform:** use `formatters` for both custom and overriding formatters ([6bb0d1b](https://github.com/echasnovski/LazyVim/commit/6bb0d1b66ffe6d0a77ad96d0f945113ddcb9fdb3))
* **dap:** copy config before overriding args ([72f3cc6](https://github.com/echasnovski/LazyVim/commit/72f3cc684bd1e8f19b2d3c56da3f359032b8c5dc))
* **dap:** move launchjs code from java to dap ([f1af34e](https://github.com/echasnovski/LazyVim/commit/f1af34e88525cc291b7bacc76d915b642aef192b))
* **dap:** revert loading vscode launch files. Add it to your own config when needed. Fixes [#1503](https://github.com/echasnovski/LazyVim/issues/1503) ([36d6a7f](https://github.com/echasnovski/LazyVim/commit/36d6a7fe4f4e7d5c9ffceca0496655a889df2ebc))
* **dasboard:** disable alpha only once ([d6b56c0](https://github.com/echasnovski/LazyVim/commit/d6b56c075e88ce12e9e16fb2eeeea38fb7853600))
* **dashboard-nvim:** repository has moved to nvimdev/dashboard-nvim ([#1715](https://github.com/echasnovski/LazyVim/issues/1715)) ([ff9bf00](https://github.com/echasnovski/LazyVim/commit/ff9bf005b6957bb46a5541188925f32a1d86365d))
* **dashboard:** config shortcut when opening dashboard again. Fixes [#1768](https://github.com/echasnovski/LazyVim/issues/1768) ([5c16567](https://github.com/echasnovski/LazyVim/commit/5c1656729aeb39fbb8dc29d4f3d6d86d0836f8b4))
* disable context commentstring autocmd ([0bff29c](https://github.com/echasnovski/LazyVim/commit/0bff29c07a0d5fb4ef36ba4add2b9c4ee243f8a9))
* **docker:** put hadolint in its own spec ([718c5c6](https://github.com/echasnovski/LazyVim/commit/718c5c6036f2aff6534501e151dd3e5ff13a42fa))
* dont lazy-load on ft. Load on cmd or keys only ([3a93757](https://github.com/echasnovski/LazyVim/commit/3a93757bb1ee28c3e1b59c6c47ea5c4e74d8f1b2))
* **dot:** treesitter langs in dot extra were not added ([b0ded5c](https://github.com/echasnovski/LazyVim/commit/b0ded5c015a68f07a32fab64a2cd0f27f4d69870))
* **edgy:** corrected filetype for symbols outline ([d5a9c54](https://github.com/echasnovski/LazyVim/commit/d5a9c54faf2a41355d4e2e14b050af188a49365a))
* **edgy:** only add symbolsoutline to the sidebar if it is installed. ([ed89d01](https://github.com/echasnovski/LazyVim/commit/ed89d01113b7c8495224cb7a88fe5ccb3f001ac5))
* **edgy:** typo ([9357ea2](https://github.com/echasnovski/LazyVim/commit/9357ea2881fdd57b028256597c01e15601c29aaf))
* **elixir:** only enable credo when installed. Fixes [#1546](https://github.com/echasnovski/LazyVim/issues/1546) ([8a1de2b](https://github.com/echasnovski/LazyVim/commit/8a1de2b90a699bdfee704f3d4422e2ced18ae0f3))
* **extras.go:** remove unneeded formatters since gopls handles them ([#1535](https://github.com/echasnovski/LazyVim/issues/1535)) ([964dd6c](https://github.com/echasnovski/LazyVim/commit/964dd6c4b2135399758c87afed7e1f3c8e30b487))
* **extras:** make sure we use priorities to import extras in correct order ([a4e3931](https://github.com/echasnovski/LazyVim/commit/a4e393154f61b95da5835b6461e211eb94740268))
* fixes [#1207](https://github.com/echasnovski/LazyVim/issues/1207) ([#1213](https://github.com/echasnovski/LazyVim/issues/1213)) ([2e09051](https://github.com/echasnovski/LazyVim/commit/2e0905147269d92d58627303bcae60bbcb3807dd))
* **flash:** depraction warning ([299aae3](https://github.com/echasnovski/LazyVim/commit/299aae3545aa7b7a67a6907e089d80cd63938bf6))
* **flash:** don't override `R` in normal mode ([c5759a4](https://github.com/echasnovski/LazyVim/commit/c5759a451f8a5635b5c2d19c82636c8b66676a3b))
* **flash:** possible nil for telescope integration ([abfdab3](https://github.com/echasnovski/LazyVim/commit/abfdab37ce127268f6410b89022417d3fa90e0ae))
* **format:** allow `custom_format` to return early ([#1531](https://github.com/echasnovski/LazyVim/issues/1531)) ([1c878b9](https://github.com/echasnovski/LazyVim/commit/1c878b9d06fb116135419d098fe5dfde5304b709))
* **format:** always show formatter status even when no sources available ([a4abbdc](https://github.com/echasnovski/LazyVim/commit/a4abbdc89bd1d49378ac5873db1279e7e5398927))
* **format:** moved formatting keymap to lua/lazyvim/config/keymaps.lua ([9b16770](https://github.com/echasnovski/LazyVim/commit/9b1677057377400ab292c51bbc085c82637a39d4))
* **format:** set formatexpr in options so users can override it. Fixes [#1759](https://github.com/echasnovski/LazyVim/issues/1759) ([ff64cc5](https://github.com/echasnovski/LazyVim/commit/ff64cc53992b966a2558e95afc449e1da29dd44d))
* **format:** wrap custom formatter with error handler ([0e5ff5c](https://github.com/echasnovski/LazyVim/commit/0e5ff5c0ab6930190122df086db5e3f91d8b38b8))
* **go:** make settings configurable for go ([1e1fc3c](https://github.com/echasnovski/LazyVim/commit/1e1fc3c6a06fb98f305d8753939c6b871ae26e33))
* **hipatterns:** remove assert. Fixes [#1045](https://github.com/echasnovski/LazyVim/issues/1045) ([6d58f1d](https://github.com/echasnovski/LazyVim/commit/6d58f1dacf1652ba49ff97631e59fc4ec9ee4faa))
* **hypr:** automatically update/install hypr treesitter parser when needed ([88d465c](https://github.com/echasnovski/LazyVim/commit/88d465c3efac065f912e1de162c9a48bbae15316))
* **ibl:** use default hl groups ([74786c2](https://github.com/echasnovski/LazyVim/commit/74786c21d743db0fabed61b90bf7ecaab16bbf14))
* **indent-blankline:** set `config.indent.tab_char` ([#1552](https://github.com/echasnovski/LazyVim/issues/1552)) ([7c5a458](https://github.com/echasnovski/LazyVim/commit/7c5a458761fe7002c6603d602e8d130b9a62dd68))
* **indent-blankline:** upgrade ibl config to v3 ([db86635](https://github.com/echasnovski/LazyVim/commit/db86635e3276451f795da4f8af64eff94391fe48))
* **java:** don't accumulate on_attach, and make more configurable ([#1388](https://github.com/echasnovski/LazyVim/issues/1388)) ([15022f4](https://github.com/echasnovski/LazyVim/commit/15022f4892726f9899ce5eb3aed7a19df29f62ef))
* **json:** always write version to prevent spurious migrations. Fixes [#1692](https://github.com/echasnovski/LazyVim/issues/1692) ([01dbd07](https://github.com/echasnovski/LazyVim/commit/01dbd070738a9448ffbdc63602ed9eb5421158da))
* **keymaps:** change `v` mode to `x` mode for `save file` ([#1262](https://github.com/echasnovski/LazyVim/issues/1262)) ([ec0ddd4](https://github.com/echasnovski/LazyVim/commit/ec0ddd481c785833c5caac9c9d22889b9e963883))
* **keymaps:** let keymap n and N opens folds ([#1298](https://github.com/echasnovski/LazyVim/issues/1298)) ([1d4fbd3](https://github.com/echasnovski/LazyVim/commit/1d4fbd3b2e48eaae448073af020ca2617ab7bd5c))
* **keymaps:** no diagnostic keymaps w/o lsp attached ([#1698](https://github.com/echasnovski/LazyVim/issues/1698)) ([873ff89](https://github.com/echasnovski/LazyVim/commit/873ff892843898033be0b59cee8130c6b1b29d85))
* **keymaps:** remove gw keymap ([23e2b07](https://github.com/echasnovski/LazyVim/commit/23e2b073e6fa75dacaa58dc1fe63392af7f54598))
* **keymaps:** remove redundant ':' on lazy keymap ([#977](https://github.com/echasnovski/LazyVim/issues/977)) ([e9358d9](https://github.com/echasnovski/LazyVim/commit/e9358d977a379e54d73dd29691d60f7a51ed6923))
* **lang_java:** fixes [#1215](https://github.com/echasnovski/LazyVim/issues/1215) other two entries of `vim.fs.joinpath` as well that were not changed in [#1213](https://github.com/echasnovski/LazyVim/issues/1213) ([#1216](https://github.com/echasnovski/LazyVim/issues/1216)) ([9fe89f5](https://github.com/echasnovski/LazyVim/commit/9fe89f5f8a5a50438276a4d2f757549ea2496ca0))
* **lang:** indentation in rust lang extra ([#1017](https://github.com/echasnovski/LazyVim/issues/1017)) ([c992ebe](https://github.com/echasnovski/LazyVim/commit/c992ebec468b2e60f1138fd85055118016c62165))
* leap nvim required by flit ([#1046](https://github.com/echasnovski/LazyVim/issues/1046)) ([dee8dc3](https://github.com/echasnovski/LazyVim/commit/dee8dc318efac8883fe149503ea92924ff4a4de2))
* **lsp-config:** lsp-config error when nvim-cmp not enabled. ([#1095](https://github.com/echasnovski/LazyVim/issues/1095)) ([3f68f44](https://github.com/echasnovski/LazyVim/commit/3f68f44d725747339933298cdac02589b37ea76c))
* **lsp:** don't install jsonls by default. It's part of the json extra ([fa6cbfc](https://github.com/echasnovski/LazyVim/commit/fa6cbfc6020efcd2168ffe09a209037599b91442))
* **lsp:** fixup lsp keymaps ([8ccc109](https://github.com/echasnovski/LazyVim/commit/8ccc109e920bcbe041c89f7e022bbfb2dbf4a09b))
* **lsp:** resolve keymap capabilities over all buffer clients ([36774c6](https://github.com/echasnovski/LazyVim/commit/36774c605848dc3bee8b9e0e4673e684b47bd89c))
* **lsp:** supports_method for checking inlay hint support ([#1195](https://github.com/echasnovski/LazyVim/issues/1195)) ([9a05435](https://github.com/echasnovski/LazyVim/commit/9a0543531d05a417ba63f3dd710530ba5765aca5))
* **lsp:** trigger FileType commands after installing LSP servers ([5b89bc8](https://github.com/echasnovski/LazyVim/commit/5b89bc8cbf990edec201d07c146a3fe28db3302f))
* **lsp:** update keymaps *after* registering capabilities ([a981682](https://github.com/echasnovski/LazyVim/commit/a981682603480e34b23615433e4ebefe07276dc2))
* **lsp:** upstream inlay_hint rename ([089606b](https://github.com/echasnovski/LazyVim/commit/089606b48dc6bb94bac36d1c30e50899a8d6f81f))
* **lualine:** only show statusline as soon as lualine loads ([dd55cbd](https://github.com/echasnovski/LazyVim/commit/dd55cbdc99021267bee8260c224582a053552dfe))
* **lualine:** when opening nvim with a file, show an empty statusline till lualine loads ([8373467](https://github.com/echasnovski/LazyVim/commit/83734675b0f93fbd11a350ee0662c09995836b59))
* **markdown:** add marksman to mason install ([3dbeda9](https://github.com/echasnovski/LazyVim/commit/3dbeda9d96a2225875c4991116cb834f20588ddb))
* **mason:** add MasonUpdate to build ([b4b27e8](https://github.com/echasnovski/LazyVim/commit/b4b27e867c4d2ba2bddd1df4c144ccdf1b4bfabc))
* **mini.comment:** better lua pattern for tags. Fixes [#1413](https://github.com/echasnovski/LazyVim/issues/1413) ([7c79cfe](https://github.com/echasnovski/LazyVim/commit/7c79cfe07314245decd73ec67e7247bba22abaa9))
* **mini.files:** changed some window widths ([d1eb9c8](https://github.com/echasnovski/LazyVim/commit/d1eb9c89d3d2959d6d106b0c11c12b21fb3bbf50))
* **neo-tree:** during init check global argslist instead of window-local ([8fbde2c](https://github.com/echasnovski/LazyVim/commit/8fbde2c3668960ed085f9225bb4650aca77cc495))
* **neo-tree:** updated some icons to use Nerd Fonts v3. Fixes [#957](https://github.com/echasnovski/LazyVim/issues/957) ([0b99c9f](https://github.com/echasnovski/LazyVim/commit/0b99c9f788f04d658b4370c8f553542563cd3482))
* **neoconf:** do neoconf setup in lspconfig setup. Fixes [#1070](https://github.com/echasnovski/LazyVim/issues/1070) ([9e8ce28](https://github.com/echasnovski/LazyVim/commit/9e8ce289d12eb65146be3cb1b3800440e208496d))
* **neotest:** better integration with trouble: no longer steals focus and hides when all ok ([2e308d5](https://github.com/echasnovski/LazyVim/commit/2e308d5440c830bb37531d03a0313af3a5c94bb5))
* **news:** dont show news when it has never been viewed (new install) ([6b9ee96](https://github.com/echasnovski/LazyVim/commit/6b9ee963e2684e7b37120b86bab5049918e14899))
* **nlua:** make nlua dap work with regular continue. Fixes [#1666](https://github.com/echasnovski/LazyVim/issues/1666) ([85215f3](https://github.com/echasnovski/LazyVim/commit/85215f396b6fd4de24636a202ec1149dafa5f7b5))
* **notify:** set default zindex=100 ([7fb7948](https://github.com/echasnovski/LazyVim/commit/7fb79486ed1b251b98b95a44ef50b3742edd708d))
* **nvim-lint:** check on linter name instead of linter. Fixes [#1685](https://github.com/echasnovski/LazyVim/issues/1685) ([cdae38d](https://github.com/echasnovski/LazyVim/commit/cdae38ddd44edbf5e124129fc94e9d1038592760))
* **nvim-lint:** dont evaluate conditions for linter functions. Fixes [#1569](https://github.com/echasnovski/LazyVim/issues/1569) ([b1ad480](https://github.com/echasnovski/LazyVim/commit/b1ad48067e2c18747bedd7b7054c3ce97ef32890))
* **nvim-lint:** dont try merging function linters ([79010ae](https://github.com/echasnovski/LazyVim/commit/79010ae671035d8ed0040ce51df4fb59ec3962f8))
* **nvim-lint:** dont use default configured linters from nvim-lint ([ff5f588](https://github.com/echasnovski/LazyVim/commit/ff5f5886db321679e3fdc5dbb82b12daf6075510))
* **nvim-lint:** make sure to set custom linters. Fixes [#1687](https://github.com/echasnovski/LazyVim/issues/1687) ([8e71968](https://github.com/echasnovski/LazyVim/commit/8e71968c2bd9e59e535cdac0a99e667f8f120322))
* **nvim-lint:** use `linters` for both custom and overriding linters ([31d9136](https://github.com/echasnovski/LazyVim/commit/31d913697bc9b731bc941362021ce06617f627d3))
* **nvim-ts-autotag:** make it actually work :) ([82da244](https://github.com/echasnovski/LazyVim/commit/82da2440e4c9d7e604cf998aee0655f78ddfdd5c))
* **options:** only enable treesitter `foldexpr` on nightly. Fixes [#1581](https://github.com/echasnovski/LazyVim/issues/1581) ([d989ecc](https://github.com/echasnovski/LazyVim/commit/d989ecc943b3240db0be3aa0369b96089cee4b40))
* **options:** set default laststatus=3 and set it to 0 before loading dashboard to prevent flickering ([1eb0192](https://github.com/echasnovski/LazyVim/commit/1eb019274b5564e66ac6c7e119c140bae262e10c))
* **options:** set sessionoptions the same as persistence ([502d324](https://github.com/echasnovski/LazyVim/commit/502d32490b29e7f52b2941cfa6a306b45633d63e))
* **plugin:** add nvim-treesitter-context rename warning ([db5d28b](https://github.com/echasnovski/LazyVim/commit/db5d28b039f656ccb47d3b9f787e8bb482cc6ec1))
* **plugin:** enable lazy_file ([f59cdff](https://github.com/echasnovski/LazyVim/commit/f59cdff4d9f04ff349cefdee0b363d573954ce0d))
* **plugin:** show warning of removed core plugin when trying to load them without having the extra ([3256abd](https://github.com/echasnovski/LazyVim/commit/3256abda65ae03358ecdbef1c7789782440fe39e))
* **plugins:** make sure init specs are loaded first ([51e25a9](https://github.com/echasnovski/LazyVim/commit/51e25a94b4ff2339028bdded993756360145d1b3))
* **prettier:** use prettier instead of prettierd. Too many people get truncated files. Fixes [#712](https://github.com/echasnovski/LazyVim/issues/712). See [#1735](https://github.com/echasnovski/LazyVim/issues/1735) ([57b504b](https://github.com/echasnovski/LazyVim/commit/57b504b9e8ae95c294c17e97e7f017f6f802ebbc))
* **project:** don't let `project.nvim` change the cwd. Leads to too much confusion ([7d8b3e8](https://github.com/echasnovski/LazyVim/commit/7d8b3e8ef96f91f96c8e3a0ba62dfab270debf9f))
* **project:** make sure to load telescope extension after telescope ran setup ([0955129](https://github.com/echasnovski/LazyVim/commit/0955129796749651e1413006e36e9a1c6d3027f3))
* **python:** add `ft` to Python keymaps, and fix "Markdown Preview" toggle description ([#1729](https://github.com/echasnovski/LazyVim/issues/1729)) ([7c60431](https://github.com/echasnovski/LazyVim/commit/7c60431c58a050cf4badced0609f3179bd284137))
* **python:** disable ruff hover correctly ([#1365](https://github.com/echasnovski/LazyVim/issues/1365)) ([451bde5](https://github.com/echasnovski/LazyVim/commit/451bde5b41ec410afbb2b5e75e339a3fc44c5587))
* **python:** make venv-selector `dap_enabled` conditional on `nvim-dap-python` ([#1529](https://github.com/echasnovski/LazyVim/issues/1529)) ([7821c0e](https://github.com/echasnovski/LazyVim/commit/7821c0e85199205af98ceedfb2c4990c96900e46))
* **python:** use venv for DAP Python ([#1457](https://github.com/echasnovski/LazyVim/issues/1457)) ([ea930e3](https://github.com/echasnovski/LazyVim/commit/ea930e35457df4a367b537c472af8d5c6e8ae7eb))
* remove deprecated leap/flit code checks ([6b05ed7](https://github.com/echasnovski/LazyVim/commit/6b05ed7dcd729322e2e5b6752655a9491cd17f86))
* **root:** dont use single-file lsps for root detection. use workspaces only ([6f88b8b](https://github.com/echasnovski/LazyVim/commit/6f88b8b36f8d4fd0e958e59b4e37e1a9ed2acb78))
* **root:** only use workspace folders that contain the buffer ([592f3b0](https://github.com/echasnovski/LazyVim/commit/592f3b03bb3cd01df42ee5db4cd6ba43937f067e))
* **root:** root dir for windows. Fixes [#1749](https://github.com/echasnovski/LazyVim/issues/1749) ([9517e64](https://github.com/echasnovski/LazyVim/commit/9517e64009a1a547f5e5b96a8fc78bf5ea0bbb6e))
* **rust:** explicitly enable nvim-cmp source registration for crates ([#1609](https://github.com/echasnovski/LazyVim/issues/1609)) ([237be9e](https://github.com/echasnovski/LazyVim/commit/237be9e3a7f5ca8165d4242d47df34d8d407f4cc))
* **rust:** remove rust-tools dep from lspconfig ([39627ca](https://github.com/echasnovski/LazyVim/commit/39627cab42cdaaab3d70c3013ce82b9caae7c623))
* **spectre:** add title to Spectre panel in edgy ([#1703](https://github.com/echasnovski/LazyVim/issues/1703)) ([7fe68d9](https://github.com/echasnovski/LazyVim/commit/7fe68d9f055fd34d95f19a8711e281ab40629482))
* **statuscolumn:** correct line numbers & respect more options ([315df37](https://github.com/echasnovski/LazyVim/commit/315df373f2d0c354b08acd607f6227b07436ce03))
* **tabnine:** run `:CmpTabnineHub` automatically on build ([#1788](https://github.com/echasnovski/LazyVim/issues/1788)) ([fad3777](https://github.com/echasnovski/LazyVim/commit/fad37772967f06c65d6f0b52c2ea6f190b3218ee))
* **tailwind:** allow overriding filetypes. Fixes [#1590](https://github.com/echasnovski/LazyVim/issues/1590) ([d3e7f77](https://github.com/echasnovski/LazyVim/commit/d3e7f7717e960bb883b35e9a75badfd5b938cace))
* **tailwind:** nil check for filetypes_include. Fixes [#1607](https://github.com/echasnovski/LazyVim/issues/1607) ([d8f4382](https://github.com/echasnovski/LazyVim/commit/d8f4382dd3850550076b33d64a5f455daf7e6450))
* **telescope:** add enums and consts to search symbols ([#1512](https://github.com/echasnovski/LazyVim/issues/1512)) ([b220e54](https://github.com/echasnovski/LazyVim/commit/b220e541594a0ef556d1515649cd99d45fe94058))
* **telescope:** remove telescope folding hack since PR with fix has been merged upstream ([02bc414](https://github.com/echasnovski/LazyVim/commit/02bc41412a14c1c0bb823421ef82ff5596f42571))
* **telescope:** replace anonymous functions in mappings by named functions ([#1294](https://github.com/echasnovski/LazyVim/issues/1294)) ([13bf797](https://github.com/echasnovski/LazyVim/commit/13bf7977a4bae39a38ef6a3fad6303366c8b4bea))
* **telescope:** typo ([017582c](https://github.com/echasnovski/LazyVim/commit/017582c05a2d87c73cfe794dd2e296cc0caf86cd))
* **terraform:** configure commentstring ([#1171](https://github.com/echasnovski/LazyVim/issues/1171)) ([e5f53ee](https://github.com/echasnovski/LazyVim/commit/e5f53ee1931fdc8c0f0d3150cbb5742dcb8ff477))
* **toggle:** dont show incorrect deprecation warning for toggle. Fixes [#1679](https://github.com/echasnovski/LazyVim/issues/1679) ([7c7b4be](https://github.com/echasnovski/LazyVim/commit/7c7b4be8dbec5c5e888d02ebdaae944fecf99407))
* **treesitter-context:** set default max_lines=3 ([0ac8f6f](https://github.com/echasnovski/LazyVim/commit/0ac8f6fb3b1705c2b675a0e3cbee4968370f047a))
* **treesitter-textobjects:** use normal ]c,]C,[c,[C when in diff-mode instead of goto class. Fixes [#1610](https://github.com/echasnovski/LazyVim/issues/1610) ([1935486](https://github.com/echasnovski/LazyVim/commit/1935486ff143dd5cf100b8c89204dc01d8e06021))
* **treesitter:** dont enable ]c, [c, ... in diff-mode ([86de423](https://github.com/echasnovski/LazyVim/commit/86de423ef029abd085531e18b197a5f90e201d98))
* **treesitter:** typo with commands ([599798a](https://github.com/echasnovski/LazyVim/commit/599798a366d5fead7e8486e1b02dd2362d2e6bd1))
* trigger ci ([755419f](https://github.com/echasnovski/LazyVim/commit/755419f39cf0ca0407a3a6a16dad35942c653572))
* **typescript:** removed `typescript.nvim` since it's deprecated ([aab365a](https://github.com/echasnovski/LazyVim/commit/aab365a9f8b6405c6c5a938cb4745e9b770f2261))
* **typescript:** use new lsp keymaps config for typescript ([4009620](https://github.com/echasnovski/LazyVim/commit/4009620651c7422b3ce11484916865073e95574d))
* **ui:** always pad to 2 cells for status column icons. Fixes [#1571](https://github.com/echasnovski/LazyVim/issues/1571) ([6cf6b0a](https://github.com/echasnovski/LazyVim/commit/6cf6b0a6241c659113f5646ff64fba7dbf5161b9))
* **ui:** better fallback for foldtext when buffer does not have TreeSitter ([762017d](https://github.com/echasnovski/LazyVim/commit/762017dc35fc961bdcc7879a5527dbccced27792))
* **ui:** check folds of the statuscolumn win instead of current win ([13e9f6e](https://github.com/echasnovski/LazyVim/commit/13e9f6e6b5b085191b0ecf194ddf4c9e2d3ae6d7))
* **ui:** dont show left signs on virtual line numbers (wrap). Fixes [#1654](https://github.com/echasnovski/LazyVim/issues/1654) ([e6d294d](https://github.com/echasnovski/LazyVim/commit/e6d294df6fbd973644d4b7f9691d5f48cc5efdde))
* **ui:** fix BufferLineClose commands ([#1756](https://github.com/echasnovski/LazyVim/issues/1756)) ([fef0b3f](https://github.com/echasnovski/LazyVim/commit/fef0b3f7564e64f92df129cd86bc904afc19b976))
* **ui:** fixed foldtext on Neovim &lt; 0.10 ([1b74d67](https://github.com/echasnovski/LazyVim/commit/1b74d67a0d5783e587dedc73a715cb0c9db6cd16))
* **ui:** include extmark signs in signcolumn. Fixes [#1596](https://github.com/echasnovski/LazyVim/issues/1596) ([337cfdb](https://github.com/echasnovski/LazyVim/commit/337cfdbec43003cb2c269e59b27167aa752bf41f))
* **ui:** Neovim &lt; 0.10 ([afbe204](https://github.com/echasnovski/LazyVim/commit/afbe2043a73b6c90476812f9cc0ca4759814e5ac))
* **ui:** properly handly signs without name. Fixes [#1612](https://github.com/echasnovski/LazyVim/issues/1612) ([0fcdbe2](https://github.com/echasnovski/LazyVim/commit/0fcdbe20daf44f00252668b3866b19ac18b339df))
* **ui:** show global marks in the correct buffer only ([3849e01](https://github.com/echasnovski/LazyVim/commit/3849e0150b0a616dbd6e7e12ec5025aff6c81d39))
* **ui:** use custom fold when treesitter foldtext returns a string ([3505329](https://github.com/echasnovski/LazyVim/commit/35053290bf957a230c8758d31ba3997c0699f5f9))
* **ui:** work-around for telescope issue with treesitter folds ([ccff868](https://github.com/echasnovski/LazyVim/commit/ccff8683ba957250d71ef66429fc877f0ee5cedb))
* **util:** dont schedule on_load ([4e8a88f](https://github.com/echasnovski/LazyVim/commit/4e8a88fc1f28d0420aa3badb703296f344d89968))
* **util:** fixed line number toggling. Closes [#1173](https://github.com/echasnovski/LazyVim/issues/1173) ([df08188](https://github.com/echasnovski/LazyVim/commit/df0818880e66086f10982827ea11332b46c3b74f))
* **util:** fixed lsp willRenameFiles support check ([21ee35f](https://github.com/echasnovski/LazyVim/commit/21ee35f7108f4eefbce84d88a002572b168fc357))
* **util:** fixup typo vim.lsp.get_active_clients ([eebdcec](https://github.com/echasnovski/LazyVim/commit/eebdceca1723801e1889d2a65bd676d17139fc6c))
* **util:** use spec to check if a plugin is enabled ([bcff5a1](https://github.com/echasnovski/LazyVim/commit/bcff5a19379e32a85049500de420aa24b271fb72))
* **which-key:** change surround group key ([#1598](https://github.com/echasnovski/LazyVim/issues/1598)) ([f1ea518](https://github.com/echasnovski/LazyVim/commit/f1ea518e29a601b773d9c9c94489fc9d273c2dea))
* **yamlls:** work-around for yaml formatting on Neovim &lt; 0.10. Fixes [#1435](https://github.com/echasnovski/LazyVim/issues/1435) ([7f5051e](https://github.com/echasnovski/LazyVim/commit/7f5051ef72cfe66eb50ddb7c973714aa8aea04ec))
* **yaml:** yaml schemas are a dict, not a list, so merge properly. Fixes [#1636](https://github.com/echasnovski/LazyVim/issues/1636) ([33c677a](https://github.com/echasnovski/LazyVim/commit/33c677a55e97ee115ad7050856856df7cd96b3e1))
* **yaml:** yaml validate and enable line folding ([#1251](https://github.com/echasnovski/LazyVim/issues/1251)) ([a62a594](https://github.com/echasnovski/LazyVim/commit/a62a5942deb281b9edce3673e656854805297199))
* **yaml:** yaml: Fix TypeError undefined length ([#1229](https://github.com/echasnovski/LazyVim/issues/1229)) ([d7ca822](https://github.com/echasnovski/LazyVim/commit/d7ca822d41bc65e31dc1019a64d5d3518c8e2470))
* **yanky:** don't override c-p insert mode telescope mapping. Fixes [#1007](https://github.com/echasnovski/LazyVim/issues/1007) ([8b1e797](https://github.com/echasnovski/LazyVim/commit/8b1e7976a004d7e0cbaec37546d2889ddab48bbb))
* **yanky:** use leader-p for telescope integration ([e83d2c8](https://github.com/echasnovski/LazyVim/commit/e83d2c814f336470fa212cef2f03ceb8ac173012))


### Performance Improvements

* added support for `LazyFile` event that properly loads file based plugins without blocking the ui ([936d74b](https://github.com/echasnovski/LazyVim/commit/936d74bb6127721eeefa62e5f697d9693ab04fdd))
* **config:** add LazyVim to the rtp early for faster spec loading ([2f16a7b](https://github.com/echasnovski/LazyVim/commit/2f16a7b2d96e912c9ab50ce99d9994413ff3678d))
* **config:** only enable LazyFile when opening a file from the cmdline ([11c9084](https://github.com/echasnovski/LazyVim/commit/11c9084ec576c8735a87550f7975640eb75e6ff7))
* dont't load schemastore as an lspconfig dep ([9d17c43](https://github.com/echasnovski/LazyVim/commit/9d17c4308713e8db7ec03871ba62ff80a3bfb79c))
* **lualine:** get rid of lualine's weird lualine_require ([13dbe4a](https://github.com/echasnovski/LazyVim/commit/13dbe4ad55a4e4b9a3dd345521b359411cdc5879))
* **navic:** enable lazy_update_context option to update context on "CursorHold" instead of of using default "CursorMove" ([#1620](https://github.com/echasnovski/LazyVim/issues/1620)) ([3c92fa4](https://github.com/echasnovski/LazyVim/commit/3c92fa4eb04f827c79c095905ca9391d540fea79))
* **options:** better detection for foldtext,statuscolumn,folexpr support ([e105c9d](https://github.com/echasnovski/LazyVim/commit/e105c9daf6e973b4a294a17b4d2d1882f2188ac6))
* **plugin:** move all lazy.nvim related code to `lazyvim.util.plugin` ([70f9195](https://github.com/echasnovski/LazyVim/commit/70f91956e7f03e740b51cbc14c87df6a6f74538f))
* **root:** cache root detection. Fixes [#1753](https://github.com/echasnovski/LazyVim/issues/1753) ([98db7ec](https://github.com/echasnovski/LazyVim/commit/98db7ec0d287adcd8eaf6a93c4a392f588b5615a))
* **treesitter:** better way of loading treesitter-textobjects ([09fafb9](https://github.com/echasnovski/LazyVim/commit/09fafb946aefd8434f479656c22b90d9bc63c684))
* **util:** closure for get_clients to prevent loading vim.lsp cascade early ([1eac633](https://github.com/echasnovski/LazyVim/commit/1eac633c4f0621d5bd07db1ab7d563db5b342e82))
* **util:** split lazyvim.util in smaller separate modules ([c8c929c](https://github.com/echasnovski/LazyVim/commit/c8c929c9fdc44cc69cb034c47bd89d2bc4e4a429))


### Documentation

* LazyVim now requires Neovim &gt;= 0.9.0 ([bfe0422](https://github.com/echasnovski/LazyVim/commit/bfe04222fe5585179f03197b01a6f6ed711d4421))
